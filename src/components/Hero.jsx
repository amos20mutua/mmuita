  ...
  return (
    <section className="card overflow-hidden p-6 md:p-9">
      <div className="max-w-2xl space-y-4">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight md:text-5xl">{content?.hero_title || 'Move faster. Spend less. Keep Nairobi cleaner.'}</h1>
        <p className="text-sm text-slate-300 md:text-base">{content?.hero_subtitle || 'Electric-first delivery that saves time, money, and emissions.'}</p>
